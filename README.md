...
6. **Stitch & Save Master (30–60s) to GCS:** Click **💾 Stitch & Save Master (30–60s) to GCS** (`POST /api/save-final`) to copy and export the active 720p video master from intermediate storage to a permanent Google Cloud Storage bucket (`final_masters/<session_name>_<master_title>.mp4`).
