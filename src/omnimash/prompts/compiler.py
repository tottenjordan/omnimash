...
REAL_NAME_PARODY_MAP: dict[str, str] = {
    ...
    r"\bRamsay\b": "Fiery Master Chef",
    r"\bJulia Child\b": "Classic Vintage Chef",
    r"\bJulia\b": "Vintage Chef",
    ...
    r"\bTravis\b": "Rodeo Trap Rapper",
    r"\bScott\b": "Rodeo Trap Star",
    r"\bTaylor Swift\b": "Pop Icon Vocalist",
    r"\bTaylor\b": "Pop Icon Vocalist",
    r"\bSwift\b": "Pop Icon",
    r"\bSeverus Snape\b": "Gothic Potion Master",
    r"\bSnape\b": "Gothic Potion Master",
    r"\bHarry Potter\b": "Spectacled Wizard Student",
    r"\bHarry\b": "Spectacled Wizard Student",
    r"\bPotter\b": "Spectacled Wizard",
    r"\bDraco Malfoy\b": "Platinum Rival Wizard",
    r"\bDraco\b": "Platinum Rival Wizard",
    r"\bMalfoy\b": "Rival Wizard Student",
    r"\bHermione Granger\b": "Scholarly Young Sorceress",
    r"\bHermione\b": "Scholarly Sorceress",
    r"\bDumbledore\b": "Venerable High Wizard",
    r"\bVoldemort\b": "Pale Dark Sorcerer",
    r"\bWaka Flocka Flame\b": "Energetic Southern Trap Legend",
    r"\bWaka Flocka\b": "Energetic Southern Trap Rapper",
    r"\bWaka\b": "Energetic Southern Trap Rapper",
    r"\bFlocka\b": "High Energy Trap Rapper",
    r"\bSnoop Dogg\b": "West Coast Rap Legend",
    r"\bSnoop\b": "West Coast Rap Icon",
    r"\bEminem\b": "Detrop Speed Rap Legend",
    r"\bBeyonce\b": "Global Pop Queen",
    r"\bBeyoncé\b": "Global Pop Queen",
    r"\bJay-Z\b": "New York Rap Mogul",
    r"\bJayZ\b": "New York Rap Mogul",
    r"\bRihanna\b": "Caribbean Pop Icon",
    r"\bKendrick Lamar\b": "Lyrical West Coast Rapper",
    r"\bKendrick\b": "Lyrical West Coast Rapper",
    r"\b50 Cent\b": "Queens Rap Mogul",
    r"\b50Cent\b": "Queens Rap Mogul",
    r"\bIce Cube\b": "West Coast Film & Rap Icon",
    r"\bGucci Mane\b": "Trap Music Pioneer",
    r"\bGucci\b": "Designer Drip Rapper",
    r"\bCardi B\b": "Bronx Rap Star",
    r"\bCardi\b": "Bronx Rap Star",
    r"\bNicki Minaj\b": "Queens Rap Queen",
    r"\bNicki\b": "Queens Rap Queen",
    r"\bMinaj\b": "Queens Rap Queen",
